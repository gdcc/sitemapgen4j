 ...
 * <pre name="code" class="java">WebSitemapGenerator wsg = new WebSitemapGenerator("https://www.example.com", myDir);
 ...
 * <pre name="code" class="java">WebSitemapGenerator wsg = WebSitemapGenerator.builder("https://www.example.com", myDir)
